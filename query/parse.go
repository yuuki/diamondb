...
yydefault:
	...
	case 2:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line query/parse.go.y:32
		{
			yyVAL.expr = BoolExpr{Literal: true}
		}
	case 3:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line query/parse.go.y:36
		{
			yyVAL.expr = BoolExpr{Literal: false}
		}
	case 4:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line query/parse.go.y:40
		{
